...
function initAdminHandlers() {
  document.body.addEventListener('click', async e => {
    ...
    switch (action) {
      ...
      case 'save-post': savePost(btn.dataset.status); break;
      ...
      case 'duplicate-post': duplicatePost(btn.dataset.id); break;
      case 'delete-post': deletePost(btn.dataset.id); break;
      case 'edit-proj': editProj(btn.dataset.id); break;
      case 'delete-proj': deleteProj(btn.dataset.id); break;
  ...
  document.body.addEventListener('drop', e => {
    ...
    e.preventDefault();
    dropReorder({ preventDefault() {}, currentTarget: row }, row.dataset.reorder);
  });
}
